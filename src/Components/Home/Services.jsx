...
export default function Services() {
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-col">
      <div className="flex flex-wrap sm:flex-row justify-center flex-col py-6 mb-12">
        <h1 className="sm:w-2/5 p-4 rounded-2xl bg-white font-bold title-font text-2xl mb-2 sm:mb-0 text-pink-700">Our Services</h1>
      </div>
    </div>
